...
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN ('Blood Sugar Fasting','Blood Sugar P.P','Blood Sugar Random',
                  'Post Blood Sugar (120 mins)','Post Blood Sugar (90 mins)',
                  'Post Blood Sugar (60 mins)','Post Blood Sugar (30 mins)','Fasting Blood Sugar')
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN ('Creatinine Kinase','Urine Protein Creatinine Ratio',
                  'Urine Creatinine','Creatinine Clearance','Creatinine'
...
SELECT '2.6 Potassium' AS 'Blood Sugar Test' ,
   SUM(CASE WHEN o.value_numeric IS NOT NULL THEN 1 END ) AS 'Total Exam' ,
   SUM(CASE WHEN o.value_numeric <= 3.6 THEN 1 END)  AS 'Low' ,
	SUM(CASE WHEN o.value_numeric >= 5.2 THEN 1 END)  AS 'High'         
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
...
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN (
                 'Direct Bilirubin', 'Bilirubin Direct',
						...
						'Albumin (Serum)', 'Albumin (Routine Urine)',
						'S. Albumin', 'Alkaline Phosphatase', 'Protein (Serum)')
	AND o.obs_datetime BETWEEN '#startDate#' AND '#endDate#'
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN ('Direct Bilirubin', 'Bilirubin Direct')
	AND o.obs_datetime BETWEEN '#startDate#' AND '#endDate#'
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN ('Total bilirubin', 'Bilirubin Total' )
	AND o.obs_datetime BETWEEN '#startDate#' AND '#endDate#'
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN ('Albumin (Serum)', 'Albumin (Routine Urine)','S. Albumin')
	AND o.obs_datetime BETWEEN '#startDate#' AND '#endDate#'
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN ('Total Cholesterol/HDL','S. Triglyceride', 'LDL')
	AND o.obs_datetime BETWEEN '#startDate#' AND '#endDate#'
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name = 'Total Cholesterol/HDL'
	AND o.obs_datetime BETWEEN '#startDate#' AND '#endDate#'
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN ('Protein (Pericardial Fluid)', 'Protein (Pyrotinial Fluid)','Protein (Pleural Fluid)',
						'Urine Protein','Protein (Serum)','Protein (Plural Fluid)',
						'Protein (CSF)', 'S. Protein','Protein (Pus)')
	AND o.obs_datetime BETWEEN '#startDate#' AND '#endDate#'  
...
FROM openmrs.obs o 
INNER JOIN openmrs.concept_name c ON o.concept_id = c.concept_id 
   AND c.name IN  ('Glucose (CSF)','Glucose (Pericardial Fluid)','Glucose(P.P)','Glucose(F)', 'Glucose (Pleural Fluid)', 'Glucose (Peritoneal Fluid)', 'Glucose(R)',
