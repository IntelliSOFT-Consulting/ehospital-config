...
'Cumulative no. of diabetes patients in care' AS 'Diagnosis' ,
 SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes mellitus, type 1 ','Diabetes mellitus, type 2','Gestational Diabetes Mellitus','Diabetes secondary to other causes')  AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED" AND p.gender = 'M') THEN 1 END)  AS 'MALE',
 SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes mellitus, type 1 ','Diabetes mellitus, type 2','Gestational Diabetes Mellitus','Diabetes secondary to other causes')  AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED" AND p.gender = 'F') THEN 1 END)  AS 'FEMALE', 
...
'Cumulative no. of hypertension patients in care' AS 'Diagnosis' ,
 SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Hypertension', 'Pre-eclampsia')  AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND  p.gender = 'M' THEN 1 END)  AS 'Male' ,  
 SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Hypertension', 'Pre-eclampsia')  AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND  p.gender = 'F' THEN 1 END)  AS 'FEMale' , 
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('New') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") and p.gender = 'M' THEN 1 END)  AS 'Male'  ,  
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('New') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") and p.gender = 'F' THEN 1 END)  AS 'Female'  ,  
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes mellitus, type 1') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") and p.gender = 'M' THEN 1 END)  AS 'Male',
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes mellitus, type 1') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") and p.gender = 'F' THEN 1 END)  AS 'Feale',
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes mellitus, type 2') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") and p.gender = 'M' THEN 1 END)  AS 'Male',
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes mellitus, type 2') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") and p.gender = 'F' THEN 1 END)  AS 'Feale',
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Gestational Diabetes Mellitus') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Gestational Diabetes Mellitus') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes secondary to other causes') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diabetes secondary to other causes') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Insulin') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Insulin') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('OGLAs,Treatment Drug') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('OGLAs,Treatment Drug') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('OGLAs,Treatment Drug' ,'Insulin') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('OGLAs,Treatment Drug' ,'Insulin') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diet and Physical Activity Drugs') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Diet and Physical Activity Drugs') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT
'0-18 years' AS 'Diagnosis' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('New','Known') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('New','Known') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Antihypertensives') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Antihypertensives') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'Stroke' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Stroke') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Stroke') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'Ischemic heart disease' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Ischemic heart disease' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Ischemic heart disease' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'Peripheral vascular/artery disease' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Peripheral vascular disease' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Peripheral vascular disease' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'Heart failure' AS 'Diagnosis' ,
   SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Heart failure' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Heart failure' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
'Nephropathy') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Peripheral Neuropathy',
'Nephropathy') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name IN ('Peripheral Neuropathy',
...
SELECT 'No. of patients screened for diabetic foot' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Diabetic foot' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Diabetic foot' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'No. of feet saved through treatment' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Surgical debridement' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  = 'Surgical debridement' AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'No. of Amputation due to diabetic foot' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('Amputation') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('Amputation') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'No. with kidney complications (new diagnosis)' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'No. Screened for Tuberculosis' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('TRUE') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('TRUE') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'No. Screened Positive for Tuberclosis' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('POSTIVE') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('POSTIVE') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
...
SELECT 'Total admitted' AS 'Diagnosis' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('Admitted') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'M'THEN 1 END)  AS 'Male' ,
    SUM(CASE WHEN o.value_coded = (SELECT c.concept_id FROM openmrs.concept_name c WHERE c.name  IN ('Admitted') AND c.locale = 'en' AND c.concept_name_type = "FULLY_SPECIFIED") AND p.gender = 'F'THEN 1 END)  AS 'Female' ,
